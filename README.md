...
```bash
git clone https://github.com/devaup125/Pallet-Pose-Estimation-Load-Compliance.git
...
- **Google Drive:** https://drive.google.com/drive/folders/1tF6j7d0ILlLpaoVtEwcUxsOeaE-2ju96?usp=sharing
